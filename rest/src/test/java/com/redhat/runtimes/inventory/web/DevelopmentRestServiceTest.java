...
public class DevelopmentRestServiceTest {
  ...
  public void setup() throws IOException {
    // Setup two jvm instances with the same hostname, combining for 12 jar hashes
    ...
    // Setup an EapInstance
    entityManager.persist(TestUtils.getEapInstanceFromJsonFile("eap_example1.json"));
  }
    ...
    String text =
      ...
      ***
      ...
      Sample requests:
        ...
        curl -X GET http://127.0.0.1:9087/api/runtimes-inventory-service/v1/eap-instances/\\?hostname=freya -H "x-rh-identity:%s"

        curl -X GET http://127.0.0.1:9087/api/runtimes-inventory-service/v1/eap-instances/\\?hostname=freya&includeRaw=false -H "x-rh-identity:%s"

        curl -X GET http://127.0.0.1:9087/api/runtimes-inventory-service/v1/eap-instances/\\?hostname=freya&includeRaw=true -H "x-rh-identity:%s"
